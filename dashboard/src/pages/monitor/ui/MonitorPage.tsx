/**
 * Страница мониторинга -- активные звонки + pipeline логи.
 */
...
import { PipelineLog } from "@/features/pipeline-log";
import type { CallSession, PipelineLogEntry } from "@/shared/types";
...
export function MonitorPage({
  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
      ...
      {/* Pipeline Logs */}
      <PipelineLog logs={pipelineLogs} onClear={onClearLogs} />
    </div>
  );
}
